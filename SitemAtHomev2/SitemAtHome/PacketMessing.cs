...
namespace SitemAtHome
{
    ...
    public class SitemAtHome : TerrariaPlugin
    {
        ...
        private void sitem(CommandArgs args)
        {
            ...
            modItm.inner.useAnimation = itm.useAnimation;
            modItm.inner.useTime = itm.useTime;
            modItm.inner.shoot = itm.shoot;
            modItm.inner.shootSpeed = itm.shootSpeed;
            modItm.inner.width = itm.width;
            modItm.inner.height = itm.height;
            modItm.inner.scale = itm.scale;
            modItm.inner.ammo = itm.ammo;
            modItm.inner.useAmmo = itm.useAmmo;
            modItm.inner.notAmmo = itm.notAmmo;
